...
//!  NUC140VE3CN.
//!
//! \param ch  E_TIMER_CHANNEL, it could be E_TMR0/E_TMR1/E_TMR2
...
//*****************************************************************************
//
//! \brief Start counting of the specified timer channel.Only NuMicro NUC1x0xxxBx
//! and NUC1x0xxxCx series support this function,ex:NUC140RD2BN, NUC140VE3CN.
//!
//! \param ch  E_TIMER_CHANNEL, it could be E_TMR0/E_TMR1/E_TMR2
//!
//! \return E_SUCCESS                                Operation successful
...
//!  timer channel. Only NuMicro NUC1x0xxxBx and NUC1x0xxxCx series support
//!  this function,ex:NUC140RD2BN, NUC140VE3CN.
//!
//! \param ch  E_TIMER_CHANNEL, it could be E_TMR0/E_TMR1/E_TMR2
//!
...
//!  and set to start catpure or reset specified timer counter.The TIMER clock 
//!  source should be set as HCLK .Only NuMicro NUC1x0xxxBx and NUC1x0xxxCx 
//!  series support this function,ex: NUC140VE3CN.
//!
//! \param ch:   E_TIMER_CHANNEL, it could be E_TMR0/E_TMR1/E_TMR2/E_TMR3
...
//!  Only NuMicro NUC1x0xxxBx and NUC1x0xxxCx series support this function,ex: 
//!  NUC140VE3CN.
//!
//! \param ch:   E_TIMER_CHANNEL, it could be E_TMR0/E_TMR1/E_TMR2/E_TMR3
//!
...
//!  the timer counter. Only NuMicro NUC1x0xxxBx and NUC1x0xxxCx series support
//!  this function,ex: NUC140VE3CN.
//!
//! \param ch:   E_TIMER_CHANNEL, it could be E_TMR0/E_TMR1/E_TMR2/E_TMR3
//! \param mode: E_TIMER_RSTCAP_MODE
//!              E_CAPTURE : Run capture function
...
//*****************************************************************************
//
//! \brief This function is used to select to configure the detect edge of timer 
//! capture mode,Only NuMicro NUC1x0xxxBx and NUC1x0xxxCx series support this
//! function,ex: NUC140VE3CN.
//!
//! \param ch:   E_TIMER_CHANNEL, it could be E_TMR0/E_TMR1/E_TMR2/E_TMR3
...
//*****************************************************************************
//
//! \brief This function is used to select to enable the timer external interrupt
//! function,If any transition on TEX pin and matched with the E_TIMER_TEX_EDGE 
//! cause the external interrupt flag(TEXIF) to 1.Only NuMicro NUC1x0xxxBx and 
//! NUC1x0xxxCx series support this function,ex: NUC140VE3CN.
//!
//! \param ch:   E_TIMER_CHANNEL, it could be E_TMR0/E_TMR1/E_TMR2/E_TMR3
//!
//! \return E_SUCCESS
...
//! function,Only NuMicro NUC1x0xxxBx and NUC1x0xxxCx series support this function,
//! ex: NUC140VE3CN.
//!
//! \param ch:   E_TIMER_CHANNEL, it could be E_TMR0/E_TMR1/E_TMR2/E_TMR3
//!
...
//*****************************************************************************
//
//! \brief This function is used to enable the specified capture function.Only
//!  NuMicro NUC1x0xxxBx and NUC1x0xxxCx series support this function,
//! ex: NUC140VE3CN.
//!
//! \param ch:   E_TIMER_CHANNEL, it could be E_TMR0/E_TMR1/E_TMR2/E_TMR3
//!
...
//*****************************************************************************
//
//! \brief This function is used to disable the specified capture function.Only
//!  NuMicro NUC1x0xxxBx and NUC1x0xxxCx series support this function,
//! ex: NUC140VE3CN.
//!
//! \param ch:   E_TIMER_CHANNEL, it could be E_TMR0/E_TMR1/E_TMR2/E_TMR3
...
//!  channel.And the return data is valid only if the capture interrupt flag set
//!  to 1 by H.W.Only NuMicro NUC1x0xxxBx and NUC1x0xxxCx series support this
//!  function,ex: NUC140VE3CN.
//!
//! \param ch:   E_TIMER_CHANNEL, it could be E_TMR0/E_TMR1/E_TMR2/E_TMR3
//!
...
//*****************************************************************************
//
//! \brief This function is used to Get the external interrupt flag status from
//!  from the specified timer channel.Only NuMicro NUC1x0xxxBx and NUC1x0xxxCx 
//!  series support this function,ex: NUC140VE3CN. 
//!
//! \param ch:   E_TIMER_CHANNEL, it could be E_TMR0/E_TMR1/E_TMR2/E_TMR3
//!
//! \return External interrupt flag
//!         E_DRVTIMER_CHANNEL
//
//*****************************************************************************
...
//*****************************************************************************
//
//! \brief This function is used to clear the external interrupt flag status from
//!  from the specified timer channel.Only NuMicro NUC1x0xxxBx and NUC1x0xxxCx 
//!  series support this function,ex: NUC140VE3CN. 
//!
//! \param ch:   E_TIMER_CHANNEL, it could be E_TMR0/E_TMR1/E_TMR2/E_TMR3
...
//*****************************************************************************
//
//! \brief This function is used to enable the debounce function of specified 
//! capture input source.Only NuMicro NUC1x0xxxBx and NUC1x0xxxCx series 
//! support this function,ex: NUC140VE3CN. 
//!
//! \param ch:   E_TIMER_CHANNEL, it could be E_TMR0/E_TMR1/E_TMR2/E_TMR3
//!
//! \return E_SUCCESS
...
//*****************************************************************************
//
//! \brief This function is used to disable the debounce function of specified 
//! capture input source.Only NuMicro NUC1x0xxxBx and NUC1x0xxxCx series 
//! support this function,ex: NUC140VE3CN. 
//!
//! \param ch:   E_TIMER_CHANNEL, it could be E_TMR0/E_TMR1/E_TMR2/E_TMR3
...
//
//! \brief This function is used to enable the debounce function of specified 
//!  external counter input source.Only NuMicro NUC1x0xxxBx and NUC1x0xxxCx  
//!  series support this function,ex: NUC140VE3CN. 
//!
//! \param ch:   E_TIMER_CHANNEL, it could be E_TMR0/E_TMR1/E_TMR2/E_TMR3
//!
...
//*****************************************************************************
//
//! \brief This function is used to configure the counter detect phase of specified
//!  source.Only NuMicro NUC1x0xxxBx and NUC1x0xxxCx series support this function
//!  ex: NUC140VE3CN.
//!
//! \param ch:   E_TIMER_CHANNEL, it could be E_TMR0/E_TMR1/E_TMR2/E_TMR3
//! \param phase: E_TIMER_RSTCAP_MODE
//!              E_CAPTURE : Run capture function
//!              E_RESET   : Reset counter value of specified timer channel
//!
//! \return E_SUCCESS
...
//*****************************************************************************
//
//! \brief The WatchDog Timer(WDT) default IRQ, declared in startup_NUC1xx.s.
//!  All bits in WDT register are write-protected.User must to check the
//!  REGWRPROT bit is enabled or disabled if write the specified WDT bit fail.
//!
//! \param None
//!
//! \return None
...
//*****************************************************************************
//
//! \brief This function is used to enable WDT engine clock and set WDT time-out 
//! interval.All bits in WDT register are write-protected. User must check the 
//! REGWRPROT bit is enabled or disabled if write the specified WDT bit fail.
//!
...
//*****************************************************************************
//
//! \brief This function is used to install WDT interrupt service routine.All bits
//!  in WDT register are write-protected. User must check the REGWRPROT bit is
...
//! and set the WDT time-out interval.All bits in WDT register are write-protected.                                                        */
//! User must check the REGWRPROT bit is enabled or disabled if write the specified 
//! WDT bit fail.
//!

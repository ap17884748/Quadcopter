...
//*****************************************************************************
//
//! \brief ISR to handle PWMA interrupt event 
//!
//! \param None 
//!
//! \return None  
...
//*****************************************************************************
//
//! \brief ISR to handle PWMB interrupt event 
//!
//! \param None 
//!
//! \return None  
...
//*****************************************************************************
//
//! \brief This function is used to get PWMA/PWMB specified timer enable/disable
//!  state 
//!
...
//*****************************************************************************
//
//! \brief This function is used to set the PWM0~7 specified timer counter Note:
...
//*****************************************************************************
//
//! \brief This function is used to get the PWM0~7 specified timer counter value
//!  
//!
//! \param u8Timer DRVPWM_TIMER0 / DRVPWM_TIMER1 / DRVPWM_TIMER2 / DRVPWM_TIMER3
//!                DRVPWM_TIMER4 / DRVPWM_TIMER5 / DRVPWM_TIMER6 / DRVPWM_TIMER7
//!
//! \return The specified timer counter value  
//
//*****************************************************************************
...
//*****************************************************************************
//
//! \brief This function is used to Enable the PWM0~7 timer/capture interrupt 
//!
//! \param u8Timer DRVPWM_TIMER0 / DRVPWM_TIMER1 / DRVPWM_TIMER2 / DRVPWM_TIMER3
//!                DRVPWM_TIMER4 / DRVPWM_TIMER5 / DRVPWM_TIMER6 / DRVPWM_TIMER7
//!  DRVPWM_CAP0   / DRVPWM_CAP1   / DRVPWM_CAP2   / DRVPWM_CAP3
//!  DRVPWM_CAP4   / DRVPWM_CAP5   / DRVPWM_CAP6   / DRVPWM_CAP7
//! \param u8Int DRVPWM_CAP_RISING_INT/DRVPWM_CAP_FALLING_INT/DRVPWM_CAP_ALL_INT
//!  (The parameter is valid only when capture function)
//! \param pfncallback The call back function for specified timer / capture 
//!
//! \return None  
//
//*****************************************************************************
...
//*****************************************************************************
//
//! \brief This function is used to disable the PWM0~7 timer/capture interrupt 
//!
//! \param u8Timer DRVPWM_TIMER0 / DRVPWM_TIMER1 / DRVPWM_TIMER2 / DRVPWM_TIMER3
//!                DRVPWM_TIMER4 / DRVPWM_TIMER5 / DRVPWM_TIMER6 / DRVPWM_TIMER7
//!  DRVPWM_CAP0   / DRVPWM_CAP1   / DRVPWM_CAP2   / DRVPWM_CAP3
...
//*****************************************************************************
//
//! \brief This function is used to clear the PWM0~7 timer/capture interrupt
//!  flag 
//!
//! \param u8Timer DRVPWM_TIMER0 / DRVPWM_TIMER1 / DRVPWM_TIMER2 / DRVPWM_TIMER3
//!                DRVPWM_TIMER4 / DRVPWM_TIMER5 / DRVPWM_TIMER6 / DRVPWM_TIMER7
...
//*****************************************************************************
//
//! \brief This function is used to get the PWM0~7 timer/capture interrupt flag 
//!
//! \param u8Timer DRVPWM_TIMER0 / DRVPWM_TIMER1 / DRVPWM_TIMER2 / DRVPWM_TIMER3
//!                DRVPWM_TIMER4 / DRVPWM_TIMER5 / DRVPWM_TIMER6 / DRVPWM_TIMER7
//!  DRVPWM_CAP0   / DRVPWM_CAP1   / DRVPWM_CAP2   / DRVPWM_CAP3
...
//*****************************************************************************
//
//! \brief This function is used to get value which latches the counter when
//!  there's a rising transition 
//!
//! \param u8Capture DRVPWM_CAP0 / DRVPWM_CAP1 / DRVPWM_CAP2 / DRVPWM_CAP3 
//!                  DRVPWM_CAP4 / DRVPWM_CAP5 / DRVPWM_CAP6 / DRVPWM_CAP7
//!
//! \return The value which latches the counter when there's a rising transition
//!   
//
//*****************************************************************************
...
//
//! \brief This function is used to get value which latches the counter when
//!  there's a falling transition 
//!
//! \param u8Capture DRVPWM_CAP0 / DRVPWM_CAP1 / DRVPWM_CAP2 / DRVPWM_CAP3
//!                  DRVPWM_CAP4 / DRVPWM_CAP5 / DRVPWM_CAP6 / DRVPWM_CAP7 
//!
//! \return The value which latches the counter when there's a falling
//!  transition  
//
//*****************************************************************************
...
//*****************************************************************************
//
//! \brief This function is used to get the rising / falling transition
//!  indicator flag 
//!
//! \param u8Capture DRVPWM_CAP0 / DRVPWM_CAP1 / DRVPWM_CAP2 / DRVPWM_CAP3
//!                  DRVPWM_CAP4 / DRVPWM_CAP5 / DRVPWM_CAP6 / DRVPWM_CAP7
//! \param u8IntType DRVPWM_CAP_RISING_FLAG / DRVPWM_CAP_FALLING_FLAG 
//!
//! \return Check if there's a rising / falling transition  
//
//*****************************************************************************
...
//*****************************************************************************
//
//! \brief This function is used to clear the rising / falling transition
//!  indicator flag 
//!
//! \param u8Capture DRVPWM_CAP0 / DRVPWM_CAP1 / DRVPWM_CAP2 / DRVPWM_CAP3
//!                  DRVPWM_CAP4 / DRVPWM_CAP5 / DRVPWM_CAP6 / DRVPWM_CAP7
//! \param u8IntType DRVPWM_CAP_RISING_FLAG/DRVPWM_CAP_FALLING_FLAG 
//!
//! \return Clear the rising / falling transition interrupt flag  
//
//*****************************************************************************
...
//*****************************************************************************
//
//! \brief Disable PWM engine clock and the Capture Input/PWM Output Enable
//!  function 
//!
//! \param None 
//!
...
//*****************************************************************************
//
//! \brief This function is used to set the dead zone length and enable/disable
//!  Dead Zone function 
//!
//! \param u8Timer DRVPWM_TIMER0 or DRVPWM_TIMER1 / DRVPWM_TIMER2 or DRVPWM_TIMER3
//!                DRVPWM_TIMER4 or DRVPWM_TIMER5 / DRVPWM_TIMER6 or DRVPWM_TIMER7
//! \param u8Length Dead Zone Length : 0~255
//! \param i32EnableDeadZone Enable DeadZone (1) / Diasble DeadZone (0) 
//!
//! \return None  
//
//*****************************************************************************
...
//*****************************************************************************
//
//! \brief This function is used to enable/disable PWM0~3 timer/capture function
//!  
//!
//! \param u8Timer DRVPWM_TIMER0 / DRVPWM_TIMER1 / DRVPWM_TIMER2 / DRVPWM_TIMER3
//!                DRVPWM_TIMER4 / DRVPWM_TIMER5 / DRVPWM_TIMER6 / DRVPWM_TIMER7
//!  DRVPWM_CAP0   / DRVPWM_CAP1   / DRVPWM_CAP2   / DRVPWM_CAP3
//!  DRVPWM_CAP4   / DRVPWM_CAP5   / DRVPWM_CAP6   / DRVPWM_CAP7
//! \param i32Enable Enable  (1) / Disable  (0) 
//!
//! \return None  
//
//*****************************************************************************
...
//=============================================================================
uint32_t DrvPWM_SetTimerClk16bit(uint8_t u8Timer, S_DRVPWM_TIME_DATA_T *sPt)
{
    uint32_t    u32Frequency;
    uint32_t    u32Freqout;
    uint16_t    u16Duty, u16cnrData, u16cmrData;
...
//*****************************************************************************
//
//! \brief This function is used to enable/disable PWM0~3 timer/capture I/O
//!  function 
//!
//! \param u8Timer DRVPWM_TIMER0 / DRVPWM_TIMER1 / DRVPWM_TIMER2 / DRVPWM_TIMER3
//!                DRVPWM_TIMER4 / DRVPWM_TIMER5 / DRVPWM_TIMER6 / DRVPWM_TIMER7
...
//*****************************************************************************
//
//! \brief This function is used to select PWM clock source 
//!
//! \param u8Timer DRVPWM_TIMER0 / DRVPWM_TIMER1 / DRVPWM_TIMER2 / DRVPWM_TIMER3
//!                DRVPWM_TIMER4 / DRVPWM_TIMER5 / DRVPWM_TIMER6 / DRVPWM_TIMER7
//! \param u8ClockSourceSelector
//!  DRVPWM_EXT_12M/DRVPWM_EXT_32K/DRVPWM_HCLK/DRVPWM_INTERNAL_22M 
//!
//! \return None  
//
//*****************************************************************************
...
//*****************************************************************************
//
//! \brief This function is used to select how to clear Capture rising & falling 
//!  Latch Indicator.Only NuMicro NUC1x0xxxCx Series (Ex. NUC140VE3CN) and Low 
//!  Density Series support this function. Please refer to TRM in detail
//!
//! \param i32option 0 : Select option to clear the Capture Latch Indicators by 
//!                      writing a '0'
//!                  1 : Select option to clear the Capture Latch Indicators by 
//!                      writing a '1'
//! \param u8ClockSourceSelector
//!  DRVPWM_EXT_12M/DRVPWM_EXT_32K/DRVPWM_HCLK/DRVPWM_INTERNAL_22M 
//!
